  ...
  return (
    <div className="bg-slate-400 py-20 px-16 grid gap-10 min-h-screen">
      <div className="bg-white p-6 rounded-3xl shadow-xl">
        ...
        <ul>
          {[1, 2, 3, 4].map((i) => (
            <div
              key={i}
              className="flex justify-between my-2 odd:bg-blue-200 even:bg-yellow-200 first:bg-teal-200 last:bg-amber-200"
            >
        ...
        <ul>
          {["a", "b", "c", ""].map((c, i) => (
            <li className="bg-red-200 my-2 empty:hidden" key={i}>
              {c}
            </li>
          ))}
        </ul>
      ...
      <div className="bg-white p-6 rounded-3xl shadow-xl">
        ...
        <div className="bg-slate-300 h-72 mb-3"></div>
